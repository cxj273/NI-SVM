...
fps_path = "./bin/MED13_resized.all"
...
for line in file:
    ...
    print "(" + cd + " && ( " + traj_skip2_cmd + " && " + traj_skip4_cmd + " && " + traj_skip6_cmd + " ) | " + txyc_traj + " | " + txyc_hog + " | " + txyc_hof + " | " + txyc_mbhx + " | " + txyc_mbhy +  " | " + fv_sp_vid_cmd + " | " + fv_nosp_vid_cmd + " | " + " > /dev/null " + "&& " + spbof_traj + " && " + spbof_hog + " && " + spbof_hof + " && " + spbof_mbhx + " && " + spbof_mbhy + " && " + record_cmd + ") 1>/dev/null 2>/dev/null"
