...
for line in file:
    ...
    output = "( " + txyc_bin + " " + centers_file + " 4096 " + index_file + " " + src_path + " " + output_path + "txyc/" + txyc_name + txyc_option + " && " + bof_bin + " " + output_path + "txyc/" + txyc_name + " 4096 10 " + output_path + "bof/" + bof_name + " 0" + " && touch " + output_path + "record/" + src_name + ".bof.record " + ")>/dev/null 2>/dev/null"
    #output = "( " + bof_bin + " " + src_path + " 4096 10 " + output_path + "bof/" + src_name + ".bof 0" + " && touch " + output_path + "record/" + src_name + ".bof.record " + ")>/dev/null 2>/dev/null"
