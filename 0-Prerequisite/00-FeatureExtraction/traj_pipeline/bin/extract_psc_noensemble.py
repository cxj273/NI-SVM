...
fps_path = "/brashear/iyu2/xcli/MEDTEST14/MED14_resized.all"
...
for line in file:
    ...
    fv_nosp_noskip_vid_cmd = fv_bin + " ./fv_nosp_noskip_vid/" + fv_name + size + segx + " " + "-1" + nosp_fv_option + "0 " + fv_codebook
    fv_nosp_noskip_shot_cmd = fv_bin + " ./fv_nosp_noskip_shot/" + fv_name + size + segx + " " + fps_num + nosp_fv_option + "0 " + fv_codebook
    ...
    print "(" + cd + " && ( ( " + traj_cmd + " | " + fv_nosp_noskip_vid_cmd + " | " + fv_nosp_noskip_shot_cmd + " ) && " + traj_skip3_cmd + " && " + traj_skip6_cmd + " ) | " + fv_xyt_256_nosp_cmd + " | " + fv_nosp_vid_cmd + " > /dev/null && " + record_cmd + ") 1>/dev/null 2>/dev/null"
