...
for line in file:
    ...
    output = "( " + txyc_bin + " " + centers_file + " 4000 " + src_path + " " + output_path + "txyc/" + src_name + ".txyc" + txyc_option + " && " + bof_bin + " " + output_path + "txyc/" + src_name + ".txyc" + " 4000 10 " + output_path + "bof/" + src_name + ".bof 0" + " && touch " + output_path + "record/" + src_name + ".bof.record " + ")>/dev/null 2>/dev/null"
