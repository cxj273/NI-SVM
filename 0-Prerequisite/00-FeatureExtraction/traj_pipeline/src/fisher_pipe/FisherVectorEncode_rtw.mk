...
MODEL                = FisherVectorEncode
MODULES              = FisherVectorEncode_data.cpp FisherVectorEncode.cpp FeatFormatParse.cpp repmat.cpp intmax.cpp getFKEncoder.cpp getSPMPooler.cpp readfeatsmat.cpp compute.cpp mpower.cpp power.cpp mrdivide.cpp rdivide.cpp isnan.cpp FKEncoder_get_output_dim.cpp intmin.cpp FEencode.cpp rand.cpp isequal.cpp nnz.cpp sum.cpp max.cpp sqrt.cpp bsxfun.cpp norm.cpp abs.cpp sign.cpp find.cpp FisherVectorEncode_initialize.cpp FisherVectorEncode_terminate.cpp FisherVectorEncode_emxutil.cpp rt_nonfinite.cpp rtGetNaN.cpp rtGetInf.cpp 
MAKEFILE             = FisherVectorEncode_rtw.mk
MATLAB_ROOT          = /opt/matlab/7.12/lib/matlab7
ALT_MATLAB_ROOT      = /opt/matlab/7.12/lib/matlab7
S_FUNCTIONS          = 
S_FUNCTIONS_LIB      = 
SOLVER               = 
NUMST                = 1
...
MODELLIB                  = FisherVectorEncode.a
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
RELATIVE_PATH_TO_ANCHOR   = /home/iyu/sfep/fisher/matlab/indep
...
ADD_INCLUDES = \
	-I/home/iyu/sfep/fisher/matlab/indep/codegen/lib/FisherVectorEncode \
	-I/home/iyu/sfep/fisher/matlab/indep \
